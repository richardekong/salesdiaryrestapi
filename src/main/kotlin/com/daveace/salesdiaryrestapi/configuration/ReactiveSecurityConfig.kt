...
import com.daveace.salesdiaryrestapi.service.ReactiveSalesDiaryCsrfTokenRepository
...
class ReactiveSecurityConfig {
    ...
    private val permittedUrls: Array<String> = arrayOf(
        "$API$SALES_DIARY_AUTH_WILD_CARD",
        "/api/sales-diary/csrf-token"
    )

    @Bean
    fun customCsrfTokenRepository():ReactiveSalesDiaryCsrfTokenRepository{
        return ReactiveSalesDiaryCsrfTokenRepository()
    }
