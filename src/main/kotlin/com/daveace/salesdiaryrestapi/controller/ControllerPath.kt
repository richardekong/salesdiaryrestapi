...
class ControllerPath {
    companion object {
        ...
        const val SALES_DIARY_MONTHLY_SALES_EVENTS_REPORT = "$SALES_DIARY_SALES_EVENTS$MONTHLY$REPORT"

        const val SALES_DIARY_QUARTERLY_SALES_EVENTS = "$SALES_DIARY_SALES_EVENTS$QUARTERLY"
        const val SALES_DIARY_QUARTERLY_SALES_EVENTS_REPORT = "$SALES_DIARY_QUARTERLY_SALES_EVENTS$REPORT"

        const val SALES_DIARY_SEMESTER_SALES_EVENTS = "$SALES_DIARY_SALES_EVENTS$SEMESTER"
        const val SALES_DIARY_SEMESTER_SALES_EVENTS_REPORT = "$SALES_DIARY_SEMESTER_SALES_EVENTS$REPORT"
