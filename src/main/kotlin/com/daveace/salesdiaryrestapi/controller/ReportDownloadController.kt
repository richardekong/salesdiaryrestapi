...
class ReportDownloadController : BaseController() {
    ...
    fun generateExtendedReport(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(
                swe, principal,
                extractAdditionalDataFromSalesEvents(eventService.findSalesEvents(), authenticatedUser.getCurrentUser(principal).flatMap { currentUser ->
    ...
    fun generateExtendedPeriodicSalesReport(
            @RequestParam(name = "from") from: String,
            @RequestParam(name = "to") to: String,
            principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    fun generateExtendedDailySalesReport(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    fun generateExtendedWeeklySalesReport(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    fun generateExtendedMonthlySalesReport(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    fun generateExtendedQuarterlySalesReport(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    fun generateExtendedSemesterSalesReport(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    fun generateExtendedYearlySalesEvent(principal: Principal, swe: ServerWebExchange): Mono<ResponseEntity<InputStreamResource>> {
        return generatedExtendedSalesEventReport(swe, principal,
    ...
    private fun extractAdditionalDataFromSalesEvents(salesEvents: Flux<SalesEvent>, metrics: Mono<SalesMetrics>): Mono<Map<String?, List<Mappable>>> {
    ...
    private fun generatedExtendedSalesEventReport(
            ...
            principal: Principal,
            data: Mono<Map<String?, List<Mappable>>>): Mono<ResponseEntity<InputStreamResource>> {
        return authenticatedUser.getCurrentUser(principal).flatMap { currentUser ->
    ...
    private fun filterResourceData(user: User, data: Mono<Map<String?, List<Mappable>>>): Mono<Map<String?, List<Mappable>>> {
        return data.apply {
            map {
